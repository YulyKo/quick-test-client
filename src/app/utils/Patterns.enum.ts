...
export enum Patterns {
  ...
  EMAIL_PATTERN = '[^\s@]+@[^\s@]+',
  TEST_AND_QUESTION_NAME_PATTERN = '[A-zА-яіїйєІЇЙЄ0-9 !?><()/*,.&%$#-]{1,}',
...
// ([A-Z]{1}[a-z']{1,20}\s[A-Z]{1}[a-z']{1,20}'?-?[a-zA-Z]{1,20})
// |([А-Я'ЇІЄ]{1}[а-я'їіє]{1,20}\s[А-Я'ЇІЄ]{1}[а-я'їіє]{1,20}'?-?[а-яА-Я'їіє'ЇІЄ]{1,20}) - with ENG
